  ...
  return (
    <>
      <GameWrapper>
        <ImageWrapper>
          ...
          <Navigation>
            <StyledButton
              ...
              className={game === 'TicTacToe' ? 'navbutton active' : 'navbutton'}
              type="button">
              TicTacToe
            </StyledButton>
            <StyledButton
              onClick={() => setGame('Memory')}
              className={game === 'Memory' ? 'navbutton active' : 'navbutton'}
              type="button">
              Memory
            </StyledButton>
            <StyledButton
              onClick={() => setGame('StoneRockScissors')}
              className={game === 'StoneRockScissors' ? 'navbutton active' : 'navbutton'}
              type="button">
              Roshambo
            </StyledButton>
            <StyledButton
              onClick={() => setGame('Quiz')}
              className={game === 'Quiz' ? 'navbutton active' : 'navbutton'}
              type="button">
              Quiz
            </StyledButton>
          </Navigation>
        ...
        <a target="_blank" href="https://profile-room.vercel.app/">
          {' '}
          &copy; BenRodProd
        </a>
      </GameWrapper>
