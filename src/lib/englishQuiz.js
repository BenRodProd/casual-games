export const englishQuiz = [
  ...
  {
    question:
      'What are the names of the four houses at Hogwarts School of Witchcraft and Wizardry?',
    answers: [
      'Gryffindor, Hufflepuff, Ravenclaw, Slytherin',
      'Ravenpaw, Slytherin, Hufflepuff, Gryffindor',
      'Hufflesnuff, Gryffindor, Slytherin, Ravenclaw',
      'Bytherin, Ravenclaw, Gryffindor, Hufflepuff'
    ],
    correctAnswerIndex: 0,
    topic: 'Harry_Potter'
  },
  {
    question:
      "What is the name of the Triwizard Tournament's second task in 'Harry Potter and the Goblet of Fire'?",
    answers: [
      'The Lake Challenge',
      'The Maze Challenge',
  ...
  {
    question:
      "Who is the author of 'Fantastic Beasts and Where to Find Them' in the Harry Potter series?",
